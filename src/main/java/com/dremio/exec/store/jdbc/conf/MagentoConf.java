...
@SourceType(value = "MagentoARP", label = "Magento",uiConfig = "magento-layout.json")
public class MagentoConf extends AbstractArpConf<MagentoConf> {
  private static final String ARP_FILENAME = "arp/implementation/magento-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.magento.MagentoDriver";
